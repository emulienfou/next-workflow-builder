...
import { checkNodeIntegration, IntegrationFixResult } from "./config/editor-config";
...
const WorkflowEditor = ({ workflowId }: Props) => {
      ...
      { !isMobile && (
        ...
        >
          ...
          >
            {/* Hover indicator */ }
            <div
              className="absolute inset-y-0 left-0 w-1 bg-transparent transition-colors group-hover:bg-blue-500 group-active:bg-blue-600"/>
