...
import { generateAIActionPrompts } from "../../../../../plugins/registry.js";
...
export const aiGenerate: RouteHandler = async (route, ctx) => {
  try {
...
{"op": "addEdge", "edge": {"id": "e-new", "source": "A", "target": "B", "type": "default"}}`;
    ...
    const result = streamText({
      // biome-ignore lint/suspicious/noExplicitAny: AI SDK resolves string model IDs via provider registry at runtime
      model: "openai/gpt-5.1-instant" as any,
