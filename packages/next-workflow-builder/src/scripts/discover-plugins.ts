...
const LAYOUT_PROVIDER_FILE = join(process.cwd(), "lib", "layout-provider.tsx");
...
/**
 * Generate the lib/layout-provider.tsx file
 * This wraps the package's LayoutProvider with a side-effect import of @/plugins
 * so that all discovered plugins are registered before any component renders.
 */
function generateLayoutProvider(): void {
  const libDir = dirname(LAYOUT_PROVIDER_FILE);
...
`;
  ...
  writeFileSync(LAYOUT_PROVIDER_FILE, content, "utf-8");
  console.log("Generated lib/layout-provider.tsx");
}
...
async function main(): Promise<void> {
  ...
  console.log("Generating lib/layout-provider.tsx...");
